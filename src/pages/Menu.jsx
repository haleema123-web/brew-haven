...
function Menu({ addToCart, openOrderModal }) {
  ...
  useEffect(() => {
    fetch("http://127.0.0.1:8000/api/menu/")
      .then((res) => res.json())
      .then((data) => {
        // ✅ YEH SAFETY CHECK ADD KIYA HAI (100% Fix)
        if (Array.isArray(data)) {
          setMenu(data);
        } else {
          console.error("Menu data format galat hai:", data);
          setMenu([]); // Agar error aaya, toh empty list set karein
        }
        setLoading(false);
      ...
      .catch((err) => {
        ...
        setMenu([]); // Error case mein bhi empty list
        setLoading(false);
      });
  }, []);
    ...
    <div className="main">
      <section className="menu-section">
        ...
        {loading ? (
          ...
          // ✅ AGAR MENU EMPTY HAI TO YEH MSG DIKHEGA
          <h2 style={{ textAlign: "center", color: "red" }}>
            Menu items load nahi ho paye. Backend check karein.
          </h2>
        ) : (
          ...
          <div className="menu-grid">
            ...
            {menu.map((item) => (
              ...
              >
                ...
                {/* ✅ YEH IMAGE FALLBACK ADD KIYA HAI */}
                <img 
